// RoboVM Note: Commented out as switched to Posix implementation that supports MacOS/iOS
// RoboVM Note: TODO: FIXME: probably should be used if targeting Linux
///*
