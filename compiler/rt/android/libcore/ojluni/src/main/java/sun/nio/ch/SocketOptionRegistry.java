...
// RoboVM Note: TODO: FIXME: it was generated for MacosX
package sun.nio.ch;
...
class SocketOptionRegistry {
    ...
    private static class LazyInitialization {
        ...
        private static Map<RegistryKey,OptionKey> options() {
            ...
            map.put(new RegistryKey(StandardSocketOptions.SO_BROADCAST, Net.UNSPEC), new OptionKey(0xffff, 0x0020));
            map.put(new RegistryKey(StandardSocketOptions.SO_KEEPALIVE, Net.UNSPEC), new OptionKey(0xffff, 0x0008));
            map.put(new RegistryKey(StandardSocketOptions.SO_LINGER, Net.UNSPEC), new OptionKey(0xffff, 0x0080));
            map.put(new RegistryKey(StandardSocketOptions.SO_SNDBUF, Net.UNSPEC), new OptionKey(0xffff, 0x1001));
            map.put(new RegistryKey(StandardSocketOptions.SO_RCVBUF, Net.UNSPEC), new OptionKey(0xffff, 0x1002));
            map.put(new RegistryKey(StandardSocketOptions.SO_REUSEADDR, Net.UNSPEC), new OptionKey(0xffff, 0x0004));
            map.put(new RegistryKey(StandardSocketOptions.TCP_NODELAY, Net.UNSPEC), new OptionKey(6, 0x01));
            ...
            map.put(new RegistryKey(ExtendedSocketOption.SO_OOBINLINE, Net.UNSPEC), new OptionKey(0xffff, 0x0100));
            return map;
        }
    }
