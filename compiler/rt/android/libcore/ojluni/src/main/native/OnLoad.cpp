// RoboVM note: commented out as initializations are not required due lazy approach/fully unified JNI names
///*
...
//extern "C" JNIEXPORT jint ojluni_OnLoad(JavaVM* vm, void*) {
