...
public @interface IBInspectable {
    /**
     * The name of the Objective-C selector this inspectable binds to. If not
     * specified the selector will be derived from the name of the method.
     */
    String selector() default "";

    /**
     * The name of the inspectable. If not specified the name will be derived from
