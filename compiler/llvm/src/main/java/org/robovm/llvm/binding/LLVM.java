...
public class LLVM extends org.robovm.llvm.binding.presets.LLVM {
    static { Loader.load(); }
...
/** enum LLVMFloatABIType */
public static final int
    LLVMFloatABITypeDefault = 0,
    LLVMFloatABITypeSoft = 1,
    LLVMFloatABITypeHard = 2;

/** enum LLVMFPOpFusionMode */
public static final int
    LLVMFPOpFusionModeFast = 0,
    LLVMFPOpFusionModeStandard = 1,
    LLVMFPOpFusionModeStrict = 2;
...
@Name("LLVMOpaqueTargetOptions") @Opaque public static class LLVMTargetOptionsRef extends Pointer {
    /** Empty constructor. Calls {@code super((Pointer)null)}. */
    public LLVMTargetOptionsRef() { super((Pointer)null); }
    /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
    public LLVMTargetOptionsRef(Pointer p) { super(p); }
}

@MemberGetter public static native @Cast("const char*") BytePointer llvmHostTriple();

public static native void LLVMPassManagerBuilderSetDisableTailCalls(LLVMPassManagerBuilderRef PMB,
                                            @Cast("LLVMBool") int Value);
public static native void LLVMPassManagerBuilderUseAlwaysInliner(LLVMPassManagerBuilderRef PMB, @Cast("LLVMBool") int InsertLifetime);

public static native @Cast("LLVMBool") int LLVMParseIR(LLVMMemoryBufferRef MemBuf,
                          @ByPtrPtr LLVMModuleRef OutModule, @Cast("char**") PointerPointer OutMessage);
public static native @Cast("LLVMBool") int LLVMParseIR(LLVMMemoryBufferRef MemBuf,
                          @ByPtrPtr LLVMModuleRef OutModule, @Cast("char**") @ByPtrPtr BytePointer OutMessage);
public static native @Cast("LLVMBool") int LLVMParseIR(LLVMMemoryBufferRef MemBuf,
...
public static native LLVMTargetRef LLVMLookupTarget(@Cast("const char*") BytePointer Triple, @Cast("char**") PointerPointer ErrorMessage);
public static native LLVMTargetRef LLVMLookupTarget(@Cast("const char*") BytePointer Triple, @Cast("char**") @ByPtrPtr BytePointer ErrorMessage);
public static native LLVMTargetRef LLVMLookupTarget(String Triple, @Cast("char**") @ByPtrPtr ByteBuffer ErrorMessage);
public static native LLVMTargetRef LLVMLookupTarget(@Cast("const char*") BytePointer Triple, @Cast("char**") @ByPtrPtr byte[] ErrorMessage);
public static native LLVMTargetRef LLVMLookupTarget(String Triple, @Cast("char**") @ByPtrPtr BytePointer ErrorMessage);
public static native LLVMTargetRef LLVMLookupTarget(@Cast("const char*") BytePointer Triple, @Cast("char**") @ByPtrPtr ByteBuffer ErrorMessage);
public static native LLVMTargetRef LLVMLookupTarget(String Triple, @Cast("char**") @ByPtrPtr byte[] ErrorMessage);

public static native @Cast("LLVMBool") int LLVMTargetMachineGetAsmVerbosityDefault(LLVMTargetMachineRef T);
public static native @Cast("LLVMBool") int LLVMTargetMachineGetDataSections(LLVMTargetMachineRef T);
public static native @Cast("LLVMBool") int LLVMTargetMachineGetFunctionSections(LLVMTargetMachineRef T);
public static native void LLVMTargetMachineSetDataSections(LLVMTargetMachineRef T, @Cast("LLVMBool") int Value);
public static native void LLVMTargetMachineSetFunctionSections(LLVMTargetMachineRef T, @Cast("LLVMBool") int Value);

public static native LLVMTargetOptionsRef LLVMGetTargetMachineTargetOptions(LLVMTargetMachineRef T);

public static native @Cast("LLVMBool") int LLVMTargetOptionsGetPrintMachineCode(LLVMTargetOptionsRef O);
public static native void LLVMTargetOptionsSetPrintMachineCode(LLVMTargetOptionsRef O, @Cast("LLVMBool") int V);
public static native @Cast("LLVMBool") int LLVMTargetOptionsGetLessPreciseFPMADOption(LLVMTargetOptionsRef O);
public static native void LLVMTargetOptionsSetLessPreciseFPMADOption(LLVMTargetOptionsRef O, @Cast("LLVMBool") int V);
public static native @Cast("LLVMBool") int LLVMTargetOptionsGetUnsafeFPMath(LLVMTargetOptionsRef O);
public static native void LLVMTargetOptionsSetUnsafeFPMath(LLVMTargetOptionsRef O, @Cast("LLVMBool") int V);
public static native @Cast("LLVMBool") int LLVMTargetOptionsGetNoInfsFPMath(LLVMTargetOptionsRef O);
public static native void LLVMTargetOptionsSetNoInfsFPMath(LLVMTargetOptionsRef O, @Cast("LLVMBool") int V);
public static native @Cast("LLVMBool") int LLVMTargetOptionsGetNoNaNsFPMath(LLVMTargetOptionsRef O);
public static native void LLVMTargetOptionsSetNoNaNsFPMath(LLVMTargetOptionsRef O, @Cast("LLVMBool") int V);
public static native @Cast("LLVMBool") int LLVMTargetOptionsGetHonorSignDependentRoundingFPMathOption(LLVMTargetOptionsRef O);
public static native void LLVMTargetOptionsSetHonorSignDependentRoundingFPMathOption(LLVMTargetOptionsRef O, @Cast("LLVMBool") int V);
public static native @Cast("LLVMBool") int LLVMTargetOptionsGetNoZerosInBSS(LLVMTargetOptionsRef O);
public static native void LLVMTargetOptionsSetNoZerosInBSS(LLVMTargetOptionsRef O, @Cast("LLVMBool") int V);
public static native @Cast("LLVMBool") int LLVMTargetOptionsGetGuaranteedTailCallOpt(LLVMTargetOptionsRef O);
public static native void LLVMTargetOptionsSetGuaranteedTailCallOpt(LLVMTargetOptionsRef O, @Cast("LLVMBool") int V);
public static native @Cast("unsigned") int LLVMTargetOptionsGetStackAlignmentOverride(LLVMTargetOptionsRef O);
public static native void LLVMTargetOptionsSetStackAlignmentOverride(LLVMTargetOptionsRef O, @Cast("unsigned") int V);
public static native @Cast("LLVMBool") int LLVMTargetOptionsGetEnableFastISel(LLVMTargetOptionsRef O);
public static native void LLVMTargetOptionsSetEnableFastISel(LLVMTargetOptionsRef O, @Cast("LLVMBool") int V);
public static native @Cast("LLVMBool") int LLVMTargetOptionsGetUseInitArray(LLVMTargetOptionsRef O);
public static native void LLVMTargetOptionsSetUseInitArray(LLVMTargetOptionsRef O, @Cast("LLVMBool") int V);
public static native @Cast("LLVMFloatABIType") int LLVMTargetOptionsGetFloatABIType(LLVMTargetOptionsRef O);
public static native void LLVMTargetOptionsSetFloatABIType(LLVMTargetOptionsRef O, @Cast("LLVMFloatABIType") int V);
public static native @Cast("LLVMFPOpFusionMode") int LLVMTargetOptionsGetAllowFPOpFusion(LLVMTargetOptionsRef O);
public static native void LLVMTargetOptionsSetAllowFPOpFusion(LLVMTargetOptionsRef O, @Cast("LLVMFPOpFusionMode") int V);

public static native void LLVMModuleSetPIELevel(LLVMModuleRef M, @Cast("LLVMPIELevel") int V);
public static native @Cast("LLVMPIELevel") int LLVMModuleGetPIELevel(LLVMModuleRef M);

public static native int LLVMTargetMachineAssembleToFile(LLVMTargetMachineRef TM, LLVMMemoryBufferRef Mem, @Cast("char*") BytePointer FilePath,
    @Cast("LLVMBool") int RelaxAll, @Cast("LLVMBool") int IncrementalLinkerCompatible, @Cast("LLVMBool") int DWARFMustBeAtTheEnd, @Cast("LLVMBool") int NoExecStack, @Cast("char**") PointerPointer ErrorMessage);
public static native int LLVMTargetMachineAssembleToFile(LLVMTargetMachineRef TM, LLVMMemoryBufferRef Mem, @Cast("char*") BytePointer FilePath,
    @Cast("LLVMBool") int RelaxAll, @Cast("LLVMBool") int IncrementalLinkerCompatible, @Cast("LLVMBool") int DWARFMustBeAtTheEnd, @Cast("LLVMBool") int NoExecStack, @Cast("char**") @ByPtrPtr BytePointer ErrorMessage);
public static native int LLVMTargetMachineAssembleToFile(LLVMTargetMachineRef TM, LLVMMemoryBufferRef Mem, @Cast("char*") ByteBuffer FilePath,
    @Cast("LLVMBool") int RelaxAll, @Cast("LLVMBool") int IncrementalLinkerCompatible, @Cast("LLVMBool") int DWARFMustBeAtTheEnd, @Cast("LLVMBool") int NoExecStack, @Cast("char**") @ByPtrPtr ByteBuffer ErrorMessage);
public static native int LLVMTargetMachineAssembleToFile(LLVMTargetMachineRef TM, LLVMMemoryBufferRef Mem, @Cast("char*") byte[] FilePath,
    @Cast("LLVMBool") int RelaxAll, @Cast("LLVMBool") int IncrementalLinkerCompatible, @Cast("LLVMBool") int DWARFMustBeAtTheEnd, @Cast("LLVMBool") int NoExecStack, @Cast("char**") @ByPtrPtr byte[] ErrorMessage);
...
public static native void LLVMGetLineInfoForAddressRange(LLVMObjectFileRef O, @Cast("uint64_t") long Address, @Cast("uint64_t") long Size, IntPointer OutSize, @Cast("uint64_t**") PointerPointer Out);
public static native void LLVMGetLineInfoForAddressRange(LLVMObjectFileRef O, @Cast("uint64_t") long Address, @Cast("uint64_t") long Size, IntPointer OutSize, @Cast("uint64_t**") @ByPtrPtr LongPointer Out);
public static native void LLVMGetLineInfoForAddressRange(LLVMObjectFileRef O, @Cast("uint64_t") long Address, @Cast("uint64_t") long Size, IntBuffer OutSize, @Cast("uint64_t**") @ByPtrPtr LongBuffer Out);
public static native void LLVMGetLineInfoForAddressRange(LLVMObjectFileRef O, @Cast("uint64_t") long Address, @Cast("uint64_t") long Size, int[] OutSize, @Cast("uint64_t**") @ByPtrPtr long[] Out);
public static native @Cast("size_t") long LLVMCopySectionContents(LLVMSectionIteratorRef SI, @Cast("char*") BytePointer Dest, @Cast("size_t") long DestSize);
public static native @Cast("size_t") long LLVMCopySectionContents(LLVMSectionIteratorRef SI, @Cast("char*") ByteBuffer Dest, @Cast("size_t") long DestSize);
public static native @Cast("size_t") long LLVMCopySectionContents(LLVMSectionIteratorRef SI, @Cast("char*") byte[] Dest, @Cast("size_t") long DestSize);
// #ifdef __cplusplus
// #endif
