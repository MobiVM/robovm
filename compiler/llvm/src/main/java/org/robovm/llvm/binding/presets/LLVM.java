...
public class LLVM implements InfoMapper {
    public void map(InfoMap infoMap) {
        infoMap.put(new Info("LLVMOpaqueContext").pointerTypes("LLVMContextRef"))
               ...
               .put(new Info("LLVMOpaqueTargetOptions").pointerTypes("LLVMTargetOptionsRef"))
               .put(new Info("LLVMTargetOptionsRef").valueTypes("LLVMTargetOptionsRef").pointerTypes("@ByPtrPtr LLVMTargetOptionsRef", "@Cast(\"LLVMTargetOptionsRef*\") PointerPointer"))
               ;
    }
}
