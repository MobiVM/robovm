...
static void throwGaiException(JNIEnv* env, const char* functionName, int error) {
  ...
  static jmethodID ctor3 = env->GetMethodID(JniConstants::GetGaiExceptionClass(env), "<init>",
                                            "(Ljava/lang/String;ILjava/lang/Throwable;)V");
  static jmethodID ctor2 = env->GetMethodID(JniConstants::GetGaiExceptionClass(env), "<init>",
  ...
  throwException(env, JniConstants::GetGaiExceptionClass(env), ctor3, ctor2, functionName, error);
}
...
static jobject makeSocketAddress(JNIEnv* env, const sockaddr_storage& ss) {
  ...
  static jmethodID ctor = env->GetMethodID(JniConstants::GetInetSocketAddressClass(env), "<init>",
...
static bool fillInetSocketAddress(JNIEnv* env, jint rc, jobject javaInetSocketAddress, const sockaddr_storage& ss) {
  ...
  static jfieldID addressFid = env->GetFieldID(JniConstants::GetInetSocketAddressClass(env), "addr", "Ljava/net/InetAddress;");
  static jfieldID portFid = env->GetFieldID(JniConstants::GetInetSocketAddressClass(env), "port", "I");
...
extern "C" jobjectArray Java_libcore_io_Posix_getifaddrs(JNIEnv* env, jobject) {
...
extern "C" jint Java_libcore_io_Posix_if_1nametoindex(JNIEnv* env, jobject, jstring name) {
...
extern "C"  jint Java_libcore_io_Posix_ioctlFlags(JNIEnv* env, jobject, jobject javaFd, jstring javaInterfaceName) {
  struct ifreq req;
  if (!fillIfreq(env, javaInterfaceName, req)) {
    return 0;
  }
...
extern "C"  jint Java_libcore_io_Posix_ioctlMTU(JNIEnv* env, jobject, jobject javaFd, jstring javaInterfaceName) {
  struct ifreq req;
  if (!fillIfreq(env, javaInterfaceName, req)) {
    return 0;
  }
