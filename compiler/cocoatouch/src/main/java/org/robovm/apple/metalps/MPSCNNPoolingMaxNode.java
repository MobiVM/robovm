...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MPSCNNPoolingMaxNode/*</name>*/ 
    ...
    /*<ptr>*/public static class MPSCNNPoolingMaxNodePtr extends Ptr<MPSCNNPoolingMaxNode, MPSCNNPoolingMaxNodePtr> {}/*</ptr>*/
    ...
    public MPSCNNPoolingMaxNode(MPSNNImageNode sourceNode, @MachineSizedUInt long kernelWidth, @MachineSizedUInt long kernelHeight, @MachineSizedUInt long strideInPixelsX, @MachineSizedUInt long strideInPixelsY) { super((SkipInit) null); initObject(init(sourceNode, kernelWidth, kernelHeight, strideInPixelsX, strideInPixelsY)); }
    @Method(selector = "initWithSource:filterSize:stride:")
    public MPSCNNPoolingMaxNode(MPSNNImageNode sourceNode, @MachineSizedUInt long size, @MachineSizedUInt long stride) { super((SkipInit) null); initObject(init(sourceNode, size, stride)); }
    @Method(selector = "initWithSource:filterSize:")
    public MPSCNNPoolingMaxNode(MPSNNImageNode sourceNode, @MachineSizedUInt long size) { super((SkipInit) null); initObject(init(sourceNode, size)); }
    /*</constructors>*/
    /*<properties>*/
