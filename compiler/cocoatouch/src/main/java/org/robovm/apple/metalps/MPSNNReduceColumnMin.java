...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MPSNNReduceColumnMin/*</name>*/ 
    ...
    public MPSNNReduceColumnMin(MTLDevice device) { super((SkipInit) null); initObject(init(device)); }
    /**
     * @since Available in iOS 11.0 and later.
     */
    @Method(selector = "initWithCoder:device:")
    public MPSNNReduceColumnMin(NSCoder aDecoder, MTLDevice device) { super((SkipInit) null); initObject(init(aDecoder, device)); }
    @Method(selector = "initWithCoder:")
    public MPSNNReduceColumnMin(NSCoder decoder) { super((SkipInit) null); initObject(init(decoder)); }
    /*</constructors>*/
    /*<properties>*/
