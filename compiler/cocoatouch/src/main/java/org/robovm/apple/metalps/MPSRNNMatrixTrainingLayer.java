...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MPSRNNMatrixTrainingLayer/*</name>*/ 
    ...
    public native void encodeCopyWeights(MTLCommandBuffer commandBuffer, NSArray<MPSMatrix> weights, MPSRNNMatrixId matrixId, MPSMatrix matrix, boolean copyFromWeightsToMatrix, @ByVal MTLOrigin matrixOffset);
    ...
    public native void encodeForwardSequence(MTLCommandBuffer commandBuffer, NSArray<MPSMatrix> sourceMatrices, MachineSizedUIntPtr sourceOffsets, NSArray<MPSMatrix> destinationMatrices, MachineSizedUIntPtr destinationOffsets, NSMutableArray<MPSRNNMatrixTrainingState> trainingStates, MPSRNNRecurrentMatrixState recurrentInputState, NSMutableArray<MPSRNNRecurrentMatrixState> recurrentOutputStates, NSArray<MPSMatrix> weights);
    @Method(selector = "encodeForwardSequenceToCommandBuffer:sourceMatrices:destinationMatrices:trainingStates:weights:")
    public native void encodeForwardSequence(MTLCommandBuffer commandBuffer, NSArray<MPSMatrix> sourceMatrices, NSArray<MPSMatrix> destinationMatrices, NSMutableArray<MPSRNNMatrixTrainingState> trainingStates, NSArray<MPSMatrix> weights);
    ...
    public native void encodeGradientSequence(MTLCommandBuffer commandBuffer, NSArray<MPSMatrix> forwardSources, NSArray<MPSMatrix> sourceGradients, NSArray<MPSMatrix> destinationGradients, NSArray<MPSMatrix> weightGradients, NSArray<MPSRNNMatrixTrainingState> trainingStates, NSArray<MPSMatrix> weights);
    /**
     * @since Available in iOS 11.0 and later.
     */
    @Method(selector = "initWithCoder:device:")
