...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTRBaseClusterBridgedDeviceBasicInformation/*</name>*/ 
    ...
    /*<bind>*/static { ObjCRuntime.bind(MTRBaseClusterBridgedDeviceBasicInformation.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MTRBaseClusterBridgedDeviceBasicInformation() {}
    protected MTRBaseClusterBridgedDeviceBasicInformation(Handle h, long handle) { super(h, handle); }
    protected MTRBaseClusterBridgedDeviceBasicInformation(SkipInit skipInit) { super(skipInit); }
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "initWithDevice:endpointID:queue:")
    public MTRBaseClusterBridgedDeviceBasicInformation(MTRBaseDevice device, NSNumber endpointID, DispatchQueue queue) { super((SkipInit) null); initObject(init(device, endpointID, queue)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    public native void readAttributeProductAppearance(@Block VoidBlock2<MTRBridgedDeviceBasicInformationClusterProductAppearanceStruct, NSError> completion);
    /**
     * @since Available in iOS 17.0 and later.
     */
    @Method(selector = "subscribeAttributeProductAppearanceWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeProductAppearance(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<MTRBridgedDeviceBasicInformationClusterProductAppearanceStruct, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
