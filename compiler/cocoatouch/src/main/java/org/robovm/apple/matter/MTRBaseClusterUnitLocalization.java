...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTRBaseClusterUnitLocalization/*</name>*/ 
    extends /*<extends>*/MTRCluster/*</extends>*/ 
    /*<implements>*//*</implements>*/ {

    /*<ptr>*/public static class MTRBaseClusterUnitLocalizationPtr extends Ptr<MTRBaseClusterUnitLocalization, MTRBaseClusterUnitLocalizationPtr> {}/*</ptr>*/
    /*<bind>*/static { ObjCRuntime.bind(MTRBaseClusterUnitLocalization.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MTRBaseClusterUnitLocalization() {}
    protected MTRBaseClusterUnitLocalization(Handle h, long handle) { super(h, handle); }
    protected MTRBaseClusterUnitLocalization(SkipInit skipInit) { super(skipInit); }
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "initWithDevice:endpointID:queue:")
    public MTRBaseClusterUnitLocalization(MTRBaseDevice device, NSNumber endpointID, DispatchQueue queue) { super((SkipInit) null); initObject(init(device, endpointID, queue)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    public native void readAttributeTemperatureUnit(@Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "writeAttributeTemperatureUnitWithValue:completion:")
    public native void writeAttributeTemperatureUnit(NSNumber value, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "writeAttributeTemperatureUnitWithValue:params:completion:")
    public native void writeAttributeTemperatureUnit(NSNumber value, MTRWriteParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "subscribeAttributeTemperatureUnitWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeTemperatureUnit(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSNumber, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
     ...
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeTemperatureUnitWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeTemperatureUnit(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
