...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/UIWritingToolsCoordinatorDelegateAdapter/*</name>*/ 
    ...
    public void requestsPreviewForTextAnimation(UIWritingToolsCoordinator writingToolsCoordinator, UIWritingToolsCoordinatorTextAnimation textAnimation, @ByVal NSRange range, UIWritingToolsCoordinatorContext context, UIWritingToolsCoordinatorTextDecoration textDecoration, @Block VoidBlock1<UITargetedPreview> completion) {}
    /**
     * @since Available in iOS 27.0 and later.
     */
    @NotImplemented("writingToolsCoordinator:requestsGrammarResultsForContext:completion:")
    public void requestsGrammarResults(UIWritingToolsCoordinator writingToolsCoordinator, UIWritingToolsCoordinatorContext context, @Block VoidBlock1<NSArray<NSTextCheckingResult>> completion) {}
    /**
     * @since Available in iOS 27.0 and later.
     */
    @NotImplemented("writingToolsCoordinator:setGrammarCheckingEnabled:")
    public void setGrammarCheckingEnabled(UIWritingToolsCoordinator writingToolsCoordinator, boolean enabled) {}
    /**
