...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTRBaseClusterPowerSourceConfiguration/*</name>*/ 
    extends /*<extends>*/MTRCluster/*</extends>*/ 
    /*<implements>*//*</implements>*/ {

    /*<ptr>*/public static class MTRBaseClusterPowerSourceConfigurationPtr extends Ptr<MTRBaseClusterPowerSourceConfiguration, MTRBaseClusterPowerSourceConfigurationPtr> {}/*</ptr>*/
    /*<bind>*/static { ObjCRuntime.bind(MTRBaseClusterPowerSourceConfiguration.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MTRBaseClusterPowerSourceConfiguration() {}
    protected MTRBaseClusterPowerSourceConfiguration(Handle h, long handle) { super(h, handle); }
    protected MTRBaseClusterPowerSourceConfiguration(SkipInit skipInit) { super(skipInit); }
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "initWithDevice:endpointID:queue:")
    public MTRBaseClusterPowerSourceConfiguration(MTRBaseDevice device, NSNumber endpointID, DispatchQueue queue) { super((SkipInit) null); initObject(init(device, endpointID, queue)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    public native void readAttributeSources(@Block VoidBlock2<NSArray<?>, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "subscribeAttributeSourcesWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeSources(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSArray<?>, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
     ...
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeSourcesWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeSources(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSArray<?>, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
