...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/PKShippingMethod/*</name>*/ 
    ...
    public PKShippingMethod(String label, NSDecimalNumber amount) { super((Handle) null, create(label, amount)); retain(getHandle()); }
    /**
     * @since Available in iOS 9.0 and later.
     */
    public PKShippingMethod(String label, NSDecimalNumber amount, PKPaymentSummaryItemType type) { super((Handle) null, create(label, amount, type)); retain(getHandle()); }
    /*</constructors>*/
    /*<properties>*/
