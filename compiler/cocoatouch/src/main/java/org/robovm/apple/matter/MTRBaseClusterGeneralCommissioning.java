...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTRBaseClusterGeneralCommissioning/*</name>*/ 
    extends /*<extends>*/MTRCluster/*</extends>*/ 
    /*<implements>*//*</implements>*/ {

    /*<ptr>*/public static class MTRBaseClusterGeneralCommissioningPtr extends Ptr<MTRBaseClusterGeneralCommissioning, MTRBaseClusterGeneralCommissioningPtr> {}/*</ptr>*/
    /*<bind>*/static { ObjCRuntime.bind(MTRBaseClusterGeneralCommissioning.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MTRBaseClusterGeneralCommissioning() {}
    protected MTRBaseClusterGeneralCommissioning(Handle h, long handle) { super(h, handle); }
    protected MTRBaseClusterGeneralCommissioning(SkipInit skipInit) { super(skipInit); }
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "initWithDevice:endpointID:queue:")
    public MTRBaseClusterGeneralCommissioning(MTRBaseDevice device, NSNumber endpointID, DispatchQueue queue) { super((SkipInit) null); initObject(init(device, endpointID, queue)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    public native void armFailSafe(MTRGeneralCommissioningClusterArmFailSafeParams params, @Block VoidBlock2<MTRGeneralCommissioningClusterArmFailSafeResponseParams, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "setRegulatoryConfigWithParams:completion:")
    public native void setRegulatoryConfig(MTRGeneralCommissioningClusterSetRegulatoryConfigParams params, @Block VoidBlock2<MTRGeneralCommissioningClusterSetRegulatoryConfigResponseParams, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "commissioningCompleteWithParams:completion:")
    public native void commissioningComplete(MTRGeneralCommissioningClusterCommissioningCompleteParams params, @Block VoidBlock2<MTRGeneralCommissioningClusterCommissioningCompleteResponseParams, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "commissioningCompleteWithCompletion:")
    public native void commissioningComplete(@Block VoidBlock2<MTRGeneralCommissioningClusterCommissioningCompleteResponseParams, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeBreadcrumbWithCompletion:")
    public native void readAttributeBreadcrumb(@Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "writeAttributeBreadcrumbWithValue:completion:")
    public native void writeAttributeBreadcrumb(NSNumber value, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "writeAttributeBreadcrumbWithValue:params:completion:")
    public native void writeAttributeBreadcrumb(NSNumber value, MTRWriteParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "subscribeAttributeBreadcrumbWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeBreadcrumb(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSNumber, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeBasicCommissioningInfoWithCompletion:")
    public native void readAttributeBasicCommissioningInfo(@Block VoidBlock2<MTRGeneralCommissioningClusterBasicCommissioningInfo, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "subscribeAttributeBasicCommissioningInfoWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeBasicCommissioningInfo(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<MTRGeneralCommissioningClusterBasicCommissioningInfo, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeRegulatoryConfigWithCompletion:")
    public native void readAttributeRegulatoryConfig(@Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "subscribeAttributeRegulatoryConfigWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeRegulatoryConfig(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSNumber, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeLocationCapabilityWithCompletion:")
    public native void readAttributeLocationCapability(@Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "subscribeAttributeLocationCapabilityWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeLocationCapability(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSNumber, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeSupportsConcurrentConnectionWithCompletion:")
    public native void readAttributeSupportsConcurrentConnection(@Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "subscribeAttributeSupportsConcurrentConnectionWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeSupportsConcurrentConnection(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSNumber, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
     ...
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeBreadcrumbWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeBreadcrumb(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeBasicCommissioningInfoWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeBasicCommissioningInfo(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<MTRGeneralCommissioningClusterBasicCommissioningInfo, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeRegulatoryConfigWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeRegulatoryConfig(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeLocationCapabilityWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeLocationCapability(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeSupportsConcurrentConnectionWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeSupportsConcurrentConnection(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
