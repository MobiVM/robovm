...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/OSLogStore/*</name>*/ 
     ...
     * @since Available in iOS 15.0 and later.
     */
    public OSLogEnumerator entriesEnumerator(OSLogEnumeratorOptions options, OSLogPosition position, NSPredicate predicate) throws NSErrorException {
       NSError.NSErrorPtr ptr = new NSError.NSErrorPtr();
       OSLogEnumerator result = entriesEnumerator(options, position, predicate, ptr);
    ...
    private native OSLogEnumerator entriesEnumerator(OSLogEnumeratorOptions options, OSLogPosition position, NSPredicate predicate, NSError.NSErrorPtr error);
    /**
     * @since Available in iOS 15.0 and later.
     */
     ...
     * @since Available in iOS 15.0 and later.
     */
    public static OSLogStore store(OSLogStoreScope scope) throws NSErrorException {
       NSError.NSErrorPtr ptr = new NSError.NSErrorPtr();
       OSLogStore result = store(scope, ptr);
       if (ptr.get() != null) { throw new NSErrorException(ptr.get()); }
       return result;
    }
    /**
    ...
    private static native OSLogStore store(OSLogStoreScope scope, NSError.NSErrorPtr error);
    /**
     * @since Available in iOS 15.0 and later.
     */
    public static OSLogStore store(NSURL url) throws NSErrorException {
       NSError.NSErrorPtr ptr = new NSError.NSErrorPtr();
       OSLogStore result = store(url, ptr);
       if (ptr.get() != null) { throw new NSErrorException(ptr.get()); }
       return result;
    }
    /**
    ...
    private static native OSLogStore store(NSURL url, NSError.NSErrorPtr error);
    /*</methods>*/
}
