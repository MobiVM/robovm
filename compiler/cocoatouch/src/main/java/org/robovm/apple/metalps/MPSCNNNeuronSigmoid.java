...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MPSCNNNeuronSigmoid/*</name>*/ 
    ...
    public MPSCNNNeuronSigmoid(MTLDevice device) { super((SkipInit) null); initObject(initWithDevice(device)); }
    /**
     * @since Available in iOS 11.3 and later.
     */
    @Method(selector = "initWithDevice:neuronDescriptor:")
    public MPSCNNNeuronSigmoid(MTLDevice device, MPSNNNeuronDescriptor neuronDescriptor) { super((SkipInit) null); initObject(init(device, neuronDescriptor)); }
    @Method(selector = "initWithCoder:device:")
    public MPSCNNNeuronSigmoid(NSCoder aDecoder, MTLDevice device) { super((SkipInit) null); initObject(init(aDecoder, device)); }
    @Method(selector = "initWithCoder:")
    public MPSCNNNeuronSigmoid(NSCoder decoder) { super((SkipInit) null); initObject(init(decoder)); }
    /*</constructors>*/
    /*<properties>*/
