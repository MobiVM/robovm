...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTRBaseClusterChannel/*</name>*/ 
    extends /*<extends>*/MTRGenericBaseCluster/*</extends>*/ 
    /*<implements>*//*</implements>*/ {

    /*<ptr>*/public static class MTRBaseClusterChannelPtr extends Ptr<MTRBaseClusterChannel, MTRBaseClusterChannelPtr> {}/*</ptr>*/
    /*<bind>*/static { ObjCRuntime.bind(MTRBaseClusterChannel.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MTRBaseClusterChannel() {}
    protected MTRBaseClusterChannel(Handle h, long handle) { super(h, handle); }
    protected MTRBaseClusterChannel(SkipInit skipInit) { super(skipInit); }
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "initWithDevice:endpointID:queue:")
    public MTRBaseClusterChannel(MTRBaseDevice device, NSNumber endpointID, DispatchQueue queue) { super((SkipInit) null); initObject(init(device, endpointID, queue)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    public native void changeChannel(MTRChannelClusterChangeChannelParams params, @Block VoidBlock2<MTRChannelClusterChangeChannelResponseParams, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "changeChannelByNumberWithParams:completion:")
    public native void changeChannelByNumber(MTRChannelClusterChangeChannelByNumberParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "skipChannelWithParams:completion:")
    public native void skipChannel(MTRChannelClusterSkipChannelParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "getProgramGuideWithParams:completion:")
    public native void getProgramGuide(MTRChannelClusterGetProgramGuideParams params, @Block VoidBlock2<MTRChannelClusterProgramGuideResponseParams, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "getProgramGuideWithCompletion:")
    public native void getProgramGuide(@Block VoidBlock2<MTRChannelClusterProgramGuideResponseParams, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "recordProgramWithParams:completion:")
    public native void recordProgram(MTRChannelClusterRecordProgramParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "cancelRecordProgramWithParams:completion:")
    public native void cancelRecordProgram(MTRChannelClusterCancelRecordProgramParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeChannelListWithCompletion:")
    public native void readAttributeChannelList(@Block VoidBlock2<NSArray<?>, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "subscribeAttributeChannelListWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeChannelList(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSArray<?>, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeLineupWithCompletion:")
    public native void readAttributeLineup(@Block VoidBlock2<MTRChannelClusterLineupInfoStruct, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "subscribeAttributeLineupWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeLineup(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<MTRChannelClusterLineupInfoStruct, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeCurrentChannelWithCompletion:")
    public native void readAttributeCurrentChannel(@Block VoidBlock2<MTRChannelClusterChannelInfoStruct, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "subscribeAttributeCurrentChannelWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeCurrentChannel(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<MTRChannelClusterChannelInfoStruct, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
     ...
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeChannelListWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeChannelList(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSArray<?>, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeLineupWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeLineup(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<MTRChannelClusterLineupInfoStruct, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeCurrentChannelWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeCurrentChannel(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<MTRChannelClusterChannelInfoStruct, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
