...
/*<visibility>*/public/*</visibility>*/ interface /*<name>*/MTLFXFrameInterpolatorBase/*</name>*/ 
    ...
    @Property(selector = "uiTextureUsage")
    MTLTextureUsage getUiTextureUsage();
    ...
    MTLPixelFormat getUiTextureFormat();
    ...
    @Property(selector = "prevColorTexture")
    MTLTexture getPrevColorTexture();
    @Property(selector = "setPrevColorTexture:")
    void setPrevColorTexture(MTLTexture v);
    ...
    @Property(selector = "deltaTime")
    float getDeltaTime();
    @Property(selector = "setDeltaTime:")
    void setDeltaTime(float v);
    @Property(selector = "nearPlane")
    float getNearPlane();
    @Property(selector = "setNearPlane:")
    void setNearPlane(float v);
    @Property(selector = "farPlane")
    float getFarPlane();
    @Property(selector = "setFarPlane:")
    ...
    @Property(selector = "uiTexture")
    MTLTexture getUiTexture();
    @Property(selector = "setUITexture:")
    void setUiTexture(MTLTexture v);
    ...
    @Property(selector = "isUITextureComposited")
    boolean isUiTextureComposited();
    @Property(selector = "setIsUITextureComposited:")
    void setUiTextureComposited(boolean v);
