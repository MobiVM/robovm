...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/SKLightNode/*</name>*/ 
    ...
    public SKLightNode(String filename) { super((Handle) null, create(filename)); retain(getHandle()); }
    /**
     * @since Available in iOS 12.0 and later.
     */
    public SKLightNode(String filename, NSSet<?> classes) throws NSErrorException {
       this(filename, classes, new NSError.NSErrorPtr());
    }
    private SKLightNode(String filename, NSSet<?> classes, NSError.NSErrorPtr ptr) throws NSErrorException {
