...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTRBaseClusterCommissionerControl/*</name>*/ 
    extends /*<extends>*/MTRGenericBaseCluster/*</extends>*/ 
    /*<implements>*//*</implements>*/ {

    /*<ptr>*/public static class MTRBaseClusterCommissionerControlPtr extends Ptr<MTRBaseClusterCommissionerControl, MTRBaseClusterCommissionerControlPtr> {}/*</ptr>*/
    /*<bind>*/static { ObjCRuntime.bind(MTRBaseClusterCommissionerControl.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MTRBaseClusterCommissionerControl() {}
    protected MTRBaseClusterCommissionerControl(Handle h, long handle) { super(h, handle); }
    protected MTRBaseClusterCommissionerControl(SkipInit skipInit) { super(skipInit); }
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "initWithDevice:endpointID:queue:")
    public MTRBaseClusterCommissionerControl(MTRBaseDevice device, NSNumber endpointID, DispatchQueue queue) { super((SkipInit) null); initObject(init(device, endpointID, queue)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    public native void requestCommissioningApproval(MTRCommissionerControlClusterRequestCommissioningApprovalParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "commissionNodeWithParams:completion:")
    public native void commissionNode(MTRCommissionerControlClusterCommissionNodeParams params, @Block VoidBlock2<MTRCommissionerControlClusterReverseOpenCommissioningWindowParams, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributeSupportedDeviceCategoriesWithCompletion:")
    public native void readAttributeSupportedDeviceCategories(@Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "subscribeAttributeSupportedDeviceCategoriesWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeSupportedDeviceCategories(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSNumber, NSError> reportHandler);
    /**
     * @since Available in iOS 18.4 and later.
     */
     ...
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributeSupportedDeviceCategoriesWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeSupportedDeviceCategories(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
