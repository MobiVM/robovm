...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTRBaseClusterAccountLogin/*</name>*/ 
    extends /*<extends>*/MTRGenericBaseCluster/*</extends>*/ 
    /*<implements>*//*</implements>*/ {

    /*<ptr>*/public static class MTRBaseClusterAccountLoginPtr extends Ptr<MTRBaseClusterAccountLogin, MTRBaseClusterAccountLoginPtr> {}/*</ptr>*/
    /*<bind>*/static { ObjCRuntime.bind(MTRBaseClusterAccountLogin.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MTRBaseClusterAccountLogin() {}
    protected MTRBaseClusterAccountLogin(Handle h, long handle) { super(h, handle); }
    protected MTRBaseClusterAccountLogin(SkipInit skipInit) { super(skipInit); }
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "initWithDevice:endpointID:queue:")
    public MTRBaseClusterAccountLogin(MTRBaseDevice device, NSNumber endpointID, DispatchQueue queue) { super((SkipInit) null); initObject(init(device, endpointID, queue)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    public native void getSetupPIN(MTRAccountLoginClusterGetSetupPINParams params, @Block VoidBlock2<MTRAccountLoginClusterGetSetupPINResponseParams, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "loginWithParams:completion:")
    public native void login(MTRAccountLoginClusterLoginParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "logoutWithParams:completion:")
    public native void logout(MTRAccountLoginClusterLogoutParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "logoutWithCompletion:")
    public native void logout(@Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
