...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTRBaseClusterThreadNetworkDirectory/*</name>*/ 
    extends /*<extends>*/MTRGenericBaseCluster/*</extends>*/ 
    /*<implements>*//*</implements>*/ {

    /*<ptr>*/public static class MTRBaseClusterThreadNetworkDirectoryPtr extends Ptr<MTRBaseClusterThreadNetworkDirectory, MTRBaseClusterThreadNetworkDirectoryPtr> {}/*</ptr>*/
    /*<bind>*/static { ObjCRuntime.bind(MTRBaseClusterThreadNetworkDirectory.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MTRBaseClusterThreadNetworkDirectory() {}
    protected MTRBaseClusterThreadNetworkDirectory(Handle h, long handle) { super(h, handle); }
    protected MTRBaseClusterThreadNetworkDirectory(SkipInit skipInit) { super(skipInit); }
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "initWithDevice:endpointID:queue:")
    public MTRBaseClusterThreadNetworkDirectory(MTRBaseDevice device, NSNumber endpointID, DispatchQueue queue) { super((SkipInit) null); initObject(init(device, endpointID, queue)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    public native void addNetwork(MTRThreadNetworkDirectoryClusterAddNetworkParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "removeNetworkWithParams:completion:")
    public native void removeNetwork(MTRThreadNetworkDirectoryClusterRemoveNetworkParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "getOperationalDatasetWithParams:completion:")
    public native void getOperationalDataset(MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams params, @Block VoidBlock2<MTRThreadNetworkDirectoryClusterOperationalDatasetResponseParams, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributePreferredExtendedPanIDWithCompletion:")
    public native void readAttributePreferredExtendedPanID(@Block VoidBlock2<NSData, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "writeAttributePreferredExtendedPanIDWithValue:completion:")
    public native void writeAttributePreferredExtendedPanID(NSData value, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "writeAttributePreferredExtendedPanIDWithValue:params:completion:")
    public native void writeAttributePreferredExtendedPanID(NSData value, MTRWriteParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "subscribeAttributePreferredExtendedPanIDWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributePreferredExtendedPanID(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSData, NSError> reportHandler);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributeThreadNetworksWithCompletion:")
    public native void readAttributeThreadNetworks(@Block VoidBlock2<NSArray<?>, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "subscribeAttributeThreadNetworksWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeThreadNetworks(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSArray<?>, NSError> reportHandler);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributeThreadNetworkTableSizeWithCompletion:")
    public native void readAttributeThreadNetworkTableSize(@Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "subscribeAttributeThreadNetworkTableSizeWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeThreadNetworkTableSize(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSNumber, NSError> reportHandler);
    /**
     * @since Available in iOS 18.4 and later.
     */
     ...
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributePreferredExtendedPanIDWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributePreferredExtendedPanID(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSData, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributeThreadNetworksWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeThreadNetworks(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSArray<?>, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributeThreadNetworkTableSizeWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeThreadNetworkTableSize(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
