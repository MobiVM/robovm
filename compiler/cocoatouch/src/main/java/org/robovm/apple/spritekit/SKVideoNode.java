...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/SKVideoNode/*</name>*/ 
     ...
     */
    public SKVideoNode(String filename, NSSet<?> classes) throws NSErrorException {
       this(filename, classes, new NSError.NSErrorPtr());
    }
    private SKVideoNode(String filename, NSSet<?> classes, NSError.NSErrorPtr ptr) throws NSErrorException {
