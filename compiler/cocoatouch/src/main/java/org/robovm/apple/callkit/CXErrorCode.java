...
public enum /*<name>*/CXErrorCode/*</name>*/ implements ValuedEnum {
     ...
     * @since Available in iOS 10.0 and later.
     */
    @GlobalValue(symbol="CXErrorDomain", optional=true)
    public static native String getClassDomain();
    /*</methods>*/

    private final long n;

    private /*<name>*/CXErrorCode/*</name>*/(long n) { this.n = n; }
    public long value() { return n; }
    public static /*<name>*/CXErrorCode/*</name>*/ valueOf(long n) {
        for (/*<name>*/CXErrorCode/*</name>*/ v : values()) {
            if (v.n == n) {
                return v;
            }
        }
