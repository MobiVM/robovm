...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTRBaseClusterThreadBorderRouterManagement/*</name>*/ 
    extends /*<extends>*/MTRGenericBaseCluster/*</extends>*/ 
    /*<implements>*//*</implements>*/ {

    /*<ptr>*/public static class MTRBaseClusterThreadBorderRouterManagementPtr extends Ptr<MTRBaseClusterThreadBorderRouterManagement, MTRBaseClusterThreadBorderRouterManagementPtr> {}/*</ptr>*/
    /*<bind>*/static { ObjCRuntime.bind(MTRBaseClusterThreadBorderRouterManagement.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MTRBaseClusterThreadBorderRouterManagement() {}
    protected MTRBaseClusterThreadBorderRouterManagement(Handle h, long handle) { super(h, handle); }
    protected MTRBaseClusterThreadBorderRouterManagement(SkipInit skipInit) { super(skipInit); }
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "initWithDevice:endpointID:queue:")
    public MTRBaseClusterThreadBorderRouterManagement(MTRBaseDevice device, NSNumber endpointID, DispatchQueue queue) { super((SkipInit) null); initObject(init(device, endpointID, queue)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    public native void getActiveDatasetRequest(MTRThreadBorderRouterManagementClusterGetActiveDatasetRequestParams params, @Block VoidBlock2<MTRThreadBorderRouterManagementClusterDatasetResponseParams, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "getActiveDatasetRequestWithCompletion:")
    public native void getActiveDatasetRequest(@Block VoidBlock2<MTRThreadBorderRouterManagementClusterDatasetResponseParams, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "getPendingDatasetRequestWithParams:completion:")
    public native void getPendingDatasetRequest(MTRThreadBorderRouterManagementClusterGetPendingDatasetRequestParams params, @Block VoidBlock2<MTRThreadBorderRouterManagementClusterDatasetResponseParams, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "getPendingDatasetRequestWithCompletion:")
    public native void getPendingDatasetRequest(@Block VoidBlock2<MTRThreadBorderRouterManagementClusterDatasetResponseParams, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "setActiveDatasetRequestWithParams:completion:")
    public native void setActiveDatasetRequest(MTRThreadBorderRouterManagementClusterSetActiveDatasetRequestParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "setPendingDatasetRequestWithParams:completion:")
    public native void setPendingDatasetRequest(MTRThreadBorderRouterManagementClusterSetPendingDatasetRequestParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributeBorderRouterNameWithCompletion:")
    public native void readAttributeBorderRouterName(@Block VoidBlock2<NSString, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "subscribeAttributeBorderRouterNameWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeBorderRouterName(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSString, NSError> reportHandler);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributeBorderAgentIDWithCompletion:")
    public native void readAttributeBorderAgentID(@Block VoidBlock2<NSData, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "subscribeAttributeBorderAgentIDWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeBorderAgentID(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSData, NSError> reportHandler);
    /**
     * @since Available in iOS 18.4 and later.
     */
    ...
    public native void readAttributeActiveDatasetTimestamp(@Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "subscribeAttributeActiveDatasetTimestampWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeActiveDatasetTimestamp(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSNumber, NSError> reportHandler);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributePendingDatasetTimestampWithCompletion:")
    public native void readAttributePendingDatasetTimestamp(@Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "subscribeAttributePendingDatasetTimestampWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributePendingDatasetTimestamp(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSNumber, NSError> reportHandler);
    /**
     * @since Available in iOS 18.4 and later.
     */
     ...
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributeBorderRouterNameWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeBorderRouterName(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSString, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributeBorderAgentIDWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeBorderAgentID(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSData, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
     ...
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributeActiveDatasetTimestampWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeActiveDatasetTimestamp(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributePendingDatasetTimestampWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributePendingDatasetTimestamp(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
