...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/HKWorkoutConfiguration/*</name>*/ 
    ...
    public HKWorkoutConfiguration(NSCoder coder) { super((SkipInit) null); initObject(init(coder)); }
    /*</constructors>*/
    /*<properties>*/
    @Property(selector = "activityType")
    public native HKWorkoutActivityType getActivityType();
    @Property(selector = "setActivityType:")
    public native void setActivityType(HKWorkoutActivityType v);
    @Property(selector = "locationType")
    public native HKWorkoutSessionLocationType getLocationType();
    @Property(selector = "setLocationType:")
    public native void setLocationType(HKWorkoutSessionLocationType v);
    @Property(selector = "swimmingLocationType")
    public native HKWorkoutSwimmingLocationType getSwimmingLocationType();
    @Property(selector = "setSwimmingLocationType:")
    public native void setSwimmingLocationType(HKWorkoutSwimmingLocationType v);
    @Property(selector = "lapLength")
