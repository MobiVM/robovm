...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MPSRNNMatrixTrainingState/*</name>*/ 
    ...
    public static native MPSRNNMatrixTrainingState createTemporaryState(MTLCommandBuffer cmdBuf, @MachineSizedUInt long bufferSize);
    @Method(selector = "temporaryStateWithCommandBuffer:textureDescriptor:")
    public static native MPSRNNMatrixTrainingState createTemporaryState(MTLCommandBuffer cmdBuf, MTLTextureDescriptor descriptor);
    @Method(selector = "temporaryStateWithCommandBuffer:")
    public static native MPSRNNMatrixTrainingState createTemporaryState(MTLCommandBuffer cmdBuf);
    /**
     * @since Available in iOS 11.3 and later.
     */
    @Method(selector = "temporaryStateWithCommandBuffer:resourceList:")
    public static native MPSRNNMatrixTrainingState createTemporaryState(MTLCommandBuffer commandBuffer, MPSStateResourceList resourceList);
    /*</methods>*/
}
