...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MPSCNNPoolingAverageNode/*</name>*/ 
    ...
    public MPSCNNPoolingAverageNode(MPSNNImageNode sourceNode, @MachineSizedUInt long kernelWidth, @MachineSizedUInt long kernelHeight, @MachineSizedUInt long strideInPixelsX, @MachineSizedUInt long strideInPixelsY) { super(sourceNode, kernelWidth, kernelHeight, strideInPixelsX, strideInPixelsY); }
    @Method(selector = "initWithSource:filterSize:stride:")
    public MPSCNNPoolingAverageNode(MPSNNImageNode sourceNode, @MachineSizedUInt long size, @MachineSizedUInt long stride) { super(sourceNode, size, stride); }
    @Method(selector = "initWithSource:filterSize:")
    public MPSCNNPoolingAverageNode(MPSNNImageNode sourceNode, @MachineSizedUInt long size) { super(sourceNode, size); }
    /*</constructors>*/
    /*<properties>*/
