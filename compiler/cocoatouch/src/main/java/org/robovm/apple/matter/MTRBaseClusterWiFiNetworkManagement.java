...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTRBaseClusterWiFiNetworkManagement/*</name>*/ 
    extends /*<extends>*/MTRGenericBaseCluster/*</extends>*/ 
    /*<implements>*//*</implements>*/ {

    /*<ptr>*/public static class MTRBaseClusterWiFiNetworkManagementPtr extends Ptr<MTRBaseClusterWiFiNetworkManagement, MTRBaseClusterWiFiNetworkManagementPtr> {}/*</ptr>*/
    /*<bind>*/static { ObjCRuntime.bind(MTRBaseClusterWiFiNetworkManagement.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MTRBaseClusterWiFiNetworkManagement() {}
    protected MTRBaseClusterWiFiNetworkManagement(Handle h, long handle) { super(h, handle); }
    protected MTRBaseClusterWiFiNetworkManagement(SkipInit skipInit) { super(skipInit); }
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "initWithDevice:endpointID:queue:")
    public MTRBaseClusterWiFiNetworkManagement(MTRBaseDevice device, NSNumber endpointID, DispatchQueue queue) { super((SkipInit) null); initObject(init(device, endpointID, queue)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    public native void networkPassphraseRequest(MTRWiFiNetworkManagementClusterNetworkPassphraseRequestParams params, @Block VoidBlock2<MTRWiFiNetworkManagementClusterNetworkPassphraseResponseParams, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "networkPassphraseRequestWithCompletion:")
    public native void networkPassphraseRequest(@Block VoidBlock2<MTRWiFiNetworkManagementClusterNetworkPassphraseResponseParams, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributeSSIDWithCompletion:")
    public native void readAttributeSSID(@Block VoidBlock2<NSData, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "subscribeAttributeSSIDWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeSSID(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSData, NSError> reportHandler);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributePassphraseSurrogateWithCompletion:")
    public native void readAttributePassphraseSurrogate(@Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "subscribeAttributePassphraseSurrogateWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributePassphraseSurrogate(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSNumber, NSError> reportHandler);
    /**
     * @since Available in iOS 18.4 and later.
     */
     ...
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributeSSIDWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeSSID(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSData, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
    @Method(selector = "readAttributePassphraseSurrogateWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributePassphraseSurrogate(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 18.4 and later.
     */
