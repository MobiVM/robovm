...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTLAccelerationStructureCurveGeometryDescriptor/*</name>*/ 
    extends /*<extends>*/MTLAccelerationStructureGeometryDescriptor/*</extends>*/ 
    /*<implements>*//*</implements>*/ {

    /*<ptr>*/public static class MTLAccelerationStructureCurveGeometryDescriptorPtr extends Ptr<MTLAccelerationStructureCurveGeometryDescriptor, MTLAccelerationStructureCurveGeometryDescriptorPtr> {}/*</ptr>*/
    /*<bind>*/static { ObjCRuntime.bind(MTLAccelerationStructureCurveGeometryDescriptor.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    public MTLAccelerationStructureCurveGeometryDescriptor() {}
    protected MTLAccelerationStructureCurveGeometryDescriptor(Handle h, long handle) { super(h, handle); }
    protected MTLAccelerationStructureCurveGeometryDescriptor(SkipInit skipInit) { super(skipInit); }
    /*</constructors>*/
    /*<properties>*/
    @Property(selector = "controlPointBuffer")
    public native MTLBuffer getControlPointBuffer();
    @Property(selector = "setControlPointBuffer:")
    public native void setControlPointBuffer(MTLBuffer v);
    @Property(selector = "controlPointBufferOffset")
    public native @MachineSizedUInt long getControlPointBufferOffset();
    @Property(selector = "setControlPointBufferOffset:")
    public native void setControlPointBufferOffset(@MachineSizedUInt long v);
    ...
    public native MTLBuffer getRadiusBuffer();
    @Property(selector = "setRadiusBuffer:")
    public native void setRadiusBuffer(MTLBuffer v);
    @Property(selector = "radiusBufferOffset")
    public native @MachineSizedUInt long getRadiusBufferOffset();
    @Property(selector = "setRadiusBufferOffset:")
    public native void setRadiusBufferOffset(@MachineSizedUInt long v);
