...
public enum /*<name>*/NEDNSProxyManagerError/*</name>*/ implements NSErrorCode {
    ...
    private /*<name>*/NEDNSProxyManagerError/*</name>*/(long n) { this.n = n; }
    public long value() { return n; }
    public static /*<name>*/NEDNSProxyManagerError/*</name>*/ valueOf(long n) {
        for (/*<name>*/NEDNSProxyManagerError/*</name>*/ v : values()) {
            if (v.n == n) {
                return v;
            }
        }
        throw new IllegalArgumentException("No constant with value " + n + " found in "
            + /*<name>*/NEDNSProxyManagerError/*</name>*/.class.getName());
    }
    ...
    public static class NSErrorWrap extends NSError {
        ...
        @Override public NSErrorCode getErrorCode() {
             try {
                 return  /*<name>*/NEDNSProxyManagerError/*</name>*/.valueOf(getCode());
        ...
        public static String getClassDomain() {
            ...
            return /*<name>*/NEDNSProxyManagerError/*</name>*/.getClassDomain();
        }
    }
}
