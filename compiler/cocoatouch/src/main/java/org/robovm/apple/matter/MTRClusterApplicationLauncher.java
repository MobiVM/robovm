...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTRClusterApplicationLauncher/*</name>*/ 
    ...
    /*<bind>*/static { ObjCRuntime.bind(MTRClusterApplicationLauncher.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MTRClusterApplicationLauncher() {}
    protected MTRClusterApplicationLauncher(Handle h, long handle) { super(h, handle); }
    protected MTRClusterApplicationLauncher(SkipInit skipInit) { super(skipInit); }
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "initWithDevice:endpointID:queue:")
    public MTRClusterApplicationLauncher(MTRDevice device, NSNumber endpointID, DispatchQueue queue) { super((SkipInit) null); initObject(init(device, endpointID, queue)); }
    /*</constructors>*/
    /*<properties>*/
     ...
     * @since Available in iOS 16.1 and later.
     */
    @Method(selector = "readAttributeCatalogListWithParams:")
    public native NSDictionary<NSString, ?> readAttributeCatalogList(MTRReadParams params);
    /**
     * @since Available in iOS 16.1 and later.
     */
    @Method(selector = "readAttributeCurrentAppWithParams:")
    public native NSDictionary<NSString, ?> readAttributeCurrentApp(MTRReadParams params);
    /**
     * @since Available in iOS 16.1 and later.
     */
    @Method(selector = "writeAttributeCurrentAppWithValue:expectedValueInterval:")
    public native void writeAttributeCurrentApp(NSDictionary<NSString, ?> dataValueDictionary, NSNumber expectedValueIntervalMs);
    /**
     * @since Available in iOS 16.1 and later.
     */
    @Method(selector = "writeAttributeCurrentAppWithValue:expectedValueInterval:params:")
    public native void writeAttributeCurrentApp(NSDictionary<NSString, ?> dataValueDictionary, NSNumber expectedValueIntervalMs, MTRWriteParams params);
    /**
     * @since Available in iOS 16.1 and later.
     */
