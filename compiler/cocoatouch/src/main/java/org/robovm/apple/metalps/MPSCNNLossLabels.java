...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MPSCNNLossLabels/*</name>*/ 
    ...
    public static native MPSCNNLossLabels createTemporaryState(MTLCommandBuffer cmdBuf, @MachineSizedUInt long bufferSize);
    @Method(selector = "temporaryStateWithCommandBuffer:textureDescriptor:")
    public static native MPSCNNLossLabels createTemporaryState(MTLCommandBuffer cmdBuf, MTLTextureDescriptor descriptor);
    @Method(selector = "temporaryStateWithCommandBuffer:")
    public static native MPSCNNLossLabels createTemporaryState(MTLCommandBuffer cmdBuf);
    /**
     * @since Available in iOS 11.3 and later.
     */
    @Method(selector = "temporaryStateWithCommandBuffer:resourceList:")
    public static native MPSCNNLossLabels createTemporaryState(MTLCommandBuffer commandBuffer, MPSStateResourceList resourceList);
    /*</methods>*/
}
