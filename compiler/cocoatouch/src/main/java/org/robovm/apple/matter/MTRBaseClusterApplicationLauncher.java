...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTRBaseClusterApplicationLauncher/*</name>*/ 
    ...
    /*<bind>*/static { ObjCRuntime.bind(MTRBaseClusterApplicationLauncher.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MTRBaseClusterApplicationLauncher() {}
    protected MTRBaseClusterApplicationLauncher(Handle h, long handle) { super(h, handle); }
    protected MTRBaseClusterApplicationLauncher(SkipInit skipInit) { super(skipInit); }
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "initWithDevice:endpointID:queue:")
    public MTRBaseClusterApplicationLauncher(MTRBaseDevice device, NSNumber endpointID, DispatchQueue queue) { super((SkipInit) null); initObject(init(device, endpointID, queue)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    public native void readAttributeCatalogList(@Block VoidBlock2<NSArray<?>, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "subscribeAttributeCatalogListWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeCatalogList(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSArray<?>, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeCurrentAppWithCompletion:")
    public native void readAttributeCurrentApp(@Block VoidBlock2<MTRApplicationLauncherClusterApplicationEPStruct, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "writeAttributeCurrentAppWithValue:completion:")
    public native void writeAttributeCurrentApp(MTRApplicationLauncherClusterApplicationEPStruct value, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "writeAttributeCurrentAppWithValue:params:completion:")
    public native void writeAttributeCurrentApp(MTRApplicationLauncherClusterApplicationEPStruct value, MTRWriteParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "subscribeAttributeCurrentAppWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeCurrentApp(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<MTRApplicationLauncherClusterApplicationEPStruct, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
     ...
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeCatalogListWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeCatalogList(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSArray<?>, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeCurrentAppWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeCurrentApp(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<MTRApplicationLauncherClusterApplicationEPStruct, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
