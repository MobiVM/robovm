...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTRBaseClusterMediaInput/*</name>*/ 
    extends /*<extends>*/MTRGenericBaseCluster/*</extends>*/ 
    /*<implements>*//*</implements>*/ {

    /*<ptr>*/public static class MTRBaseClusterMediaInputPtr extends Ptr<MTRBaseClusterMediaInput, MTRBaseClusterMediaInputPtr> {}/*</ptr>*/
    /*<bind>*/static { ObjCRuntime.bind(MTRBaseClusterMediaInput.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MTRBaseClusterMediaInput() {}
    protected MTRBaseClusterMediaInput(Handle h, long handle) { super(h, handle); }
    protected MTRBaseClusterMediaInput(SkipInit skipInit) { super(skipInit); }
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "initWithDevice:endpointID:queue:")
    public MTRBaseClusterMediaInput(MTRBaseDevice device, NSNumber endpointID, DispatchQueue queue) { super((SkipInit) null); initObject(init(device, endpointID, queue)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    public native void selectInput(MTRMediaInputClusterSelectInputParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "showInputStatusWithParams:completion:")
    public native void showInputStatus(MTRMediaInputClusterShowInputStatusParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "showInputStatusWithCompletion:")
    public native void showInputStatus(@Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "hideInputStatusWithParams:completion:")
    public native void hideInputStatus(MTRMediaInputClusterHideInputStatusParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "hideInputStatusWithCompletion:")
    public native void hideInputStatus(@Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "renameInputWithParams:completion:")
    public native void renameInput(MTRMediaInputClusterRenameInputParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeInputListWithCompletion:")
    public native void readAttributeInputList(@Block VoidBlock2<NSArray<?>, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "subscribeAttributeInputListWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeInputList(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSArray<?>, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeCurrentInputWithCompletion:")
    public native void readAttributeCurrentInput(@Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "subscribeAttributeCurrentInputWithParams:subscriptionEstablished:reportHandler:")
    public native void subscribeAttributeCurrentInput(MTRSubscribeParams params, @Block Runnable subscriptionEstablished, @Block VoidBlock2<NSNumber, NSError> reportHandler);
    /**
     * @since Available in iOS 16.4 and later.
     */
     ...
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeInputListWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeInputList(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSArray<?>, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "readAttributeCurrentInputWithClusterStateCache:endpoint:queue:completion:")
    public static native void readAttributeCurrentInput(MTRClusterStateCacheContainer clusterStateCacheContainer, NSNumber endpoint, DispatchQueue queue, @Block VoidBlock2<NSNumber, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
