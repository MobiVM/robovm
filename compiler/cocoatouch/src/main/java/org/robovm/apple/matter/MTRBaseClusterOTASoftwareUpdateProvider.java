...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MTRBaseClusterOTASoftwareUpdateProvider/*</name>*/ 
    extends /*<extends>*/MTRCluster/*</extends>*/ 
    /*<implements>*//*</implements>*/ {

    /*<ptr>*/public static class MTRBaseClusterOTASoftwareUpdateProviderPtr extends Ptr<MTRBaseClusterOTASoftwareUpdateProvider, MTRBaseClusterOTASoftwareUpdateProviderPtr> {}/*</ptr>*/
    /*<bind>*/static { ObjCRuntime.bind(MTRBaseClusterOTASoftwareUpdateProvider.class); }/*</bind>*/
    /*<constants>*//*</constants>*/
    /*<constructors>*/
    protected MTRBaseClusterOTASoftwareUpdateProvider() {}
    protected MTRBaseClusterOTASoftwareUpdateProvider(Handle h, long handle) { super(h, handle); }
    protected MTRBaseClusterOTASoftwareUpdateProvider(SkipInit skipInit) { super(skipInit); }
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "initWithDevice:endpointID:queue:")
    public MTRBaseClusterOTASoftwareUpdateProvider(MTRBaseDevice device, NSNumber endpointID, DispatchQueue queue) { super((SkipInit) null); initObject(init(device, endpointID, queue)); }
    /*</constructors>*/
    /*<properties>*/
    ...
    public native void queryImage(MTROTASoftwareUpdateProviderClusterQueryImageParams params, @Block VoidBlock2<MTROTASoftwareUpdateProviderClusterQueryImageResponseParams, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "applyUpdateRequestWithParams:completion:")
    public native void applyUpdateRequest(MTROTASoftwareUpdateProviderClusterApplyUpdateRequestParams params, @Block VoidBlock2<MTROTASoftwareUpdateProviderClusterApplyUpdateResponseParams, NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
    @Method(selector = "notifyUpdateAppliedWithParams:completion:")
    public native void notifyUpdateApplied(MTROTASoftwareUpdateProviderClusterNotifyUpdateAppliedParams params, @Block VoidBlock1<NSError> completion);
    /**
     * @since Available in iOS 16.4 and later.
     */
