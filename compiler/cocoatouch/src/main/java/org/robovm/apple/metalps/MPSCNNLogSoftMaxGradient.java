...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/MPSCNNLogSoftMaxGradient/*</name>*/ 
    ...
    public MPSCNNLogSoftMaxGradient(MTLDevice device) { super((SkipInit) null); initObject(init(device)); }
    @Method(selector = "initWithCoder:device:")
    public MPSCNNLogSoftMaxGradient(NSCoder decoder, MTLDevice device) { super((SkipInit) null); initObject(init(decoder, device)); }
    @Method(selector = "initWithCoder:")
    public MPSCNNLogSoftMaxGradient(NSCoder decoder) { super(decoder); }
    /*</constructors>*/
    /*<properties>*/
