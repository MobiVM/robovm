...
/*<visibility>*/public/*</visibility>*/ interface /*<name>*/TCControlLayout/*</name>*/ 
    ...
    TCControlLayoutAnchor getAnchor();
    @Property(selector = "setAnchor:")
    void setAnchor(TCControlLayoutAnchor v);
    @Property(selector = "anchorCoordinateSystem")
    TCControlLayoutAnchorCoordinateSystem getAnchorCoordinateSystem();
    @Property(selector = "setAnchorCoordinateSystem:")
    void setAnchorCoordinateSystem(TCControlLayoutAnchorCoordinateSystem v);
    @Property(selector = "offset")
    @ByVal CGPoint getOffset();
    @Property(selector = "setOffset:")
    void setOffset(@ByVal CGPoint v);
    ...
    @ByVal CGSize getSize();
    @Property(selector = "setSize:")
    void setSize(@ByVal CGSize v);
    @Property(selector = "position")
    @ByVal CGPoint getPosition();
    /*</properties>*/
    /*<methods>*/
