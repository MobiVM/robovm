...
* Open Intellij IDEA CE 14, setup the IDEA sdk pointing it at your IDEA installation. Also add the JARs from `libs/ant/, `plugins/android/lib, `plugins/maven/lib` and `plugins/gradle/lib` to the SDK. See http://sht.tl/uZsyoF for a full list of things to add!
